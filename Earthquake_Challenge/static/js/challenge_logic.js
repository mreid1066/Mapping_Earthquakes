...
let myStyle = {
  ...
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(data) {
    ...
    L.geoJSON(data, {
      ...
      onEachFeature: function(feature, layer) {
        console.log(layer);
          layer.bindPopup(" Plate Boundary: " + feature.properties.Name + "<br> Plate A: " + feature.properties.PlateA + "<br> Plate B: " + feature.properties.PlateB)
      }
